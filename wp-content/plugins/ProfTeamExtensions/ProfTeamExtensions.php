...
function identity_team_members( $atts, $content = null ) {
	...
	if(get_post_meta(get_the_ID(), 'Team Social One Link', true) != ''){
		...
		$socialStringOne = '<a target="_blank" href="' . esc_url(get_post_meta(get_the_ID(), 'Team Social One Link', true)) . '" class="' . get_post_meta(get_the_ID(), 'Team Social One', true) . '"><i class="fa fa-' . $gplus . '"></i></a>';
	...
	if(get_post_meta(get_the_ID(), 'Team Social Two Link', true) != ''){
		...
		$socialStringTwo = '<a target="_blank" href="' . esc_url(get_post_meta(get_the_ID(), 'Team Social Two Link', true)) . '" class="' . get_post_meta(get_the_ID(), 'Team Social Two', true) . '"><i class="fa fa-' . $gplus . '"></i></a>';
	...
	if(get_post_meta(get_the_ID(), 'Team Social Three Link', true) != ''){
		...
		$socialStringThree = '<a target="_blank" href="' . esc_url(get_post_meta(get_the_ID(), 'Team Social Three Link', true)) . '" class="' . get_post_meta(get_the_ID(), 'Team Social Three', true) . '"><i class="fa fa-' . $gplus . '"></i></a>';
