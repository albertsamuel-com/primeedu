...
function identity_post_category() {
	...
	if ( 'post' == get_post_type() ) {
		...
		if ( is_sticky() ) {
			printf( '<span class="sticky-post"><span class="genericon genericon-pinned"></span>' . __( 'Sticky', 'identity' ) . '</span>' );
		}
...
function identity_posted_date() {
	...
	$posted_date = sprintf(
		'<span class="genericon genericon-time"></span><a href="' . esc_url( get_permalink() ) . '" rel="bookmark">' . $time_string . '</a>'
	);
...
function identity_posted_on() {
	...
	$byline = sprintf(
		'<span class="sep"> | </span><span class="author vcard"><span class="genericon genericon-user"></span><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '">' . esc_html( get_the_author() ) . '</a></span>'
	);

	echo '<span class="posted-on">' . $posted_on . '</span><span class="byline"> ' . $byline . '</span>';

	edit_post_link( __( 'Edit', 'identity' ), '<span class="sep"> | </span><span class="edit-link"><span class="genericon genericon-edit"></span>', '</span>' );
}
endif;
...
function identity_entry_footer() {
	...
	if ( 'post' == get_post_type() ) {
		...
		if ( $tags_list && ! has_post_format( 'quote' ) && ! has_post_format( 'link' ) && ! has_post_format( 'chat' ) && ! has_post_format( 'status' ) && ! has_post_format( 'aside' ) ) {
			printf( '<span class="tags-links"><span class="genericon genericon-tag"></span>' . $tags_list . '</span>' );
		}
